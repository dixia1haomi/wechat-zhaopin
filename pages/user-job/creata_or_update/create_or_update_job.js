...
Page({
  ...
  sheet_pay(e) {
    ...
    e.detail.index !== false && this.setData({ pay_value: e.detail.index })   // 设置用户选择的薪资的值
  ...
  welfare(e) {
    ...
    this.setData({ welfareStr: e.detail.toString(), welfare: JSON.stringify(e.detail), rootSheetState: false })
  },
  ...
  sheet_exp(e) {
    ...
    e.detail.index !== false && this.setData({ exp_value: e.detail.index })   
    this.setData({ rootSheetState: false })  // 组件关闭就让页面滚动
  },
  ...
  sheet_education(e) {
    ...
    e.detail.index !== false && this.setData({ education_value: e.detail.index })
    this.setData({ rootSheetState: false })  // 组件关闭就让页面滚动
  },
